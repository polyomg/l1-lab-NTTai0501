...
public class StaffListController {
    ...
    public String list(Model model) {
        List<Staff> list = List.of(
                ...
                Staff.builder().id("user4@gmail.com").fullname("nguyễn văn user4").level(0).build(),
                Staff.builder().id("user5@gmail.com").fullname("nguyễn văn user5").level(1).build(),
                Staff.builder().id("user6@gmail.com").fullname("nguyễn văn user6").level(2).build()
        );

        model.addAttribute("list", list);
        return "staff-list"; // trỏ tới staff-list.html
    }

    // Bài 4 - Hiển thị trạng thái index, count, first, last, odd, even
    ...
    public String status(Model model) {
        ...
        model.addAttribute("list", list);
        return "staff-status"; // trỏ tới staff-status.html
    }

    // Bài 5 - SelectBox và Radio Button Group
    ...
    public String controls(Model model) {
        ...
        model.addAttribute("list", list);
        return "staff-controls"; // trỏ tới staff-controls.html
    }
}
